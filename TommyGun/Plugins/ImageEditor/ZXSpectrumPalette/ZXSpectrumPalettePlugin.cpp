...
{
    RL_METHOD
    frmZXSpectrum = new TfrmZXSpectrum(NULL);
}
//---------------------------------------------------------------------------
// Destructor
/**
...
HRESULT __fastcall ZXSpectrumFormat::InitialisePlugin(ZXPlugin* pPlugin)
{
    ...
    if (true == SAFE_PTR(frmZXSpectrum))
    {
        hResult = frmZXSpectrum->Initialize(pPlugin->Handle, pPlugin->ParentInstance);
    }
    return hResult;
}
//---------------------------------------------------------------------------
...
HRESULT __fastcall ZXSpectrumFormat::GetPalette(ZXPalette*& Palette)
{
    ...
    if (true == SAFE_PTR(frmZXSpectrum))
    {
        hResult = frmZXSpectrum->Palette(Palette);
    }
    return hResult;
}
//---------------------------------------------------------------------------
HRESULT __fastcall ZXSpectrumFormat::GetPalettePanel(TPanel*& Panel)
{
    ...
    if (true == SAFE_PTR(frmZXSpectrum))
    {
        Panel = frmZXSpectrum->panZXSpectrumPalette;
        hResult = S_OK;
    }
    return hResult;
}
