...
---------------------------------------------------------------------------*/
//---------------------------------------------------------------------------
#ifndef ZXVic20MultiColorPaletteH
#define ZXVic20MultiColorPaletteH
//---------------------------------------------------------------------------
#include "..\ZXPalette.h"
#include "..\ZXImage.h"
//---------------------------------------------------------------------------
namespace Scorpio
{
    ...
    namespace Vic20MultiColorPalette
    {
        enum TMultiColor { vcBackground, vcBorder, vcCharacter, vcAuxiliary };
        //---------------------------------------------------------------------------
        class ZXVic20MultiColorPalette : public ZXPalette
        {
        private:
                    class TColorStack
                    {
                    private:
                        TMultiColor         m_eColor;
                    ...
                    public:
                        __fastcall TColorStack(ZXVic20MultiColorPalette& Palette)
                    ...
                    void    __fastcall  SetPixel(int iX, int iY, TMultiColor eColor, bool bSet, ZXImage& Image);
            ...
            unsigned char   __fastcall  GetAttribute(int iX, int iY, ZXImage& Image);
                    ...
                    void    __fastcall  SeteColor(TMultiColor eColor);
        ...
        public:
                            __fastcall  ZXVic20MultiColorPalette();
            ...
            __property  TMultiColor     Color           = { read = m_eColor         , write = SeteColor         };
        };
        //---------------------------------------------------------------------------
    }
}
