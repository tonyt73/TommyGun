...
---------------------------------------------------------------------------*/
//---------------------------------------------------------------------------
#ifndef fVic20HiresPaletteH
#define fVic20HiresPaletteH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
namespace Scorpio
{
    ...
    {
        //---------------------------------------------------------------------------
        class TfrmVic20HiresPalette : public TForm
        {
    ...
    TSpeedButton *spdInkTransparent;
        ...
        public:		// User declarations
                        __fastcall  TfrmVic20HiresPalette(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE Scorpio::Vic20Palette::TfrmVic20HiresPalette *frmVic20HiresPalette;
//---------------------------------------------------------------------------
#endif
