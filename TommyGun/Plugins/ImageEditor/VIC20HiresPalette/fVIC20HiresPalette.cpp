...
//---------------------------------------------------------------------------
TfrmVic20HiresPalette *frmVic20HiresPalette = NULL;
TSpeedButton* g_ButtonsInk[8];
TSpeedButton* g_ButtonsPaper[16];
//---------------------------------------------------------------------------
__fastcall TfrmVic20HiresPalette::TfrmVic20HiresPalette(TComponent* Owner)
    : TForm(Owner)
{
}
//---------------------------------------------------------------------------
HRESULT __fastcall TfrmVic20HiresPalette::Initialize(TZX_HPLUGIN PluginHandle, HINSTANCE hParentInstance)
{
    RL_HRESULT(S_OK);
...
//---------------------------------------------------------------------------
HRESULT __fastcall TfrmVic20HiresPalette::Release(void)
{
    RL_HRESULT(S_OK);
...
//---------------------------------------------------------------------------
HRESULT __fastcall TfrmVic20HiresPalette::GetPalette(ZXPalette*& Palette)
{
    RL_METHOD
    RL_HRESULT(S_OK);
    Palette = NULL;
...
//---------------------------------------------------------------------------
void __fastcall TfrmVic20HiresPalette::OnUpdatePaletteGUI(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TfrmVic20HiresPalette::spdInk00Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TfrmVic20HiresPalette::spdPaper00Click(TObject *Sender)
{
    TComponent* Button = dynamic_cast<TComponent*>(Sender);
    if (true == SAFE_PTR(Button))
    {
