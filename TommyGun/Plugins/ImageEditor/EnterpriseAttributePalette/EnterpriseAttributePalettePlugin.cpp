...
{
    RL_METHOD
    frmEnterpriseAttributePalette = new TfrmEnterpriseAttributePalette(NULL);
...
__fastcall ZXSpectrumFormat::~ZXSpectrumFormat()
{
    ...
    SAFE_DELETE(frmEnterpriseAttributePalette);
    Release();
}
//---------------------------------------------------------------------------
// InitialisePlugin
...
HRESULT __fastcall ZXSpectrumFormat::InitialisePlugin(ZXPlugin* pPlugin)
{
    ...
    if (true == SAFE_PTR(frmEnterpriseAttributePalette))
    {
        hResult = frmEnterpriseAttributePalette->Initialize(pPlugin->Handle, pPlugin->ParentInstance);
    }
    return hResult;
}
//---------------------------------------------------------------------------
...
HRESULT __fastcall ZXSpectrumFormat::ReleasePlugin(void)
{
    ...
    if (true == SAFE_PTR(frmEnterpriseAttributePalette))
    {
        hResult = frmEnterpriseAttributePalette->Release();
    }
    return hResult;
}
//---------------------------------------------------------------------------
...
HRESULT __fastcall ZXSpectrumFormat::GetPalette(ZXPalette*& Palette)
{
    ...
    if (true == SAFE_PTR(frmEnterpriseAttributePalette))
    {
        hResult = frmEnterpriseAttributePalette->GetPalette(Palette);
    }
    return hResult;
}
//---------------------------------------------------------------------------
HRESULT __fastcall ZXSpectrumFormat::GetPalettePanel(TPanel*& Panel)
{
    ...
    if (true == SAFE_PTR(frmEnterpriseAttributePalette))
    {
        Panel = frmEnterpriseAttributePalette->panPalette;
        hResult = S_OK;
    }
    return hResult;
}
