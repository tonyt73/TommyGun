...
//---------------------------------------------------------------------------
const   String  g_sPaletteName = "MSX Multicolor Mode";
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
__fastcall ZXMSXMulticolorPalette::ZXMSXMulticolorPalette()
: ZXPalette(2, 64, 48)
{
...
//---------------------------------------------------------------------------
void __fastcall ZXMSXMulticolorPalette::Initialize(void)
{
...
//---------------------------------------------------------------------------
void __fastcall ZXMSXMulticolorPalette::Write(int X, int Y, bool bSet, ZXImage& Image)
{
...
//---------------------------------------------------------------------------
void __fastcall ZXMSXMulticolorPalette::Draw(ZXImage& Image, Graphics::TBitmap* Bitmap)
{
    //PERFORMANCE_PUSH
...
//---------------------------------------------------------------------------
void __fastcall ZXMSXMulticolorPalette::SetPixel(int iX, int iY, bool bSet, ZXImage& Image)
{
    //PERFORMANCE_PUSH
...
//---------------------------------------------------------------------------
void __fastcall ZXMSXMulticolorPalette::DoSetPixel(int iX, int iY, bool bSet, ZXImage& Image)
{
    //PERFORMANCE_PUSH
    if (0 <= iX && iX < Image.Width && 0 <= iY && iY < Image.Height)
    {
...
//---------------------------------------------------------------------------
String __fastcall ZXMSXMulticolorPalette::GetName(void)
{
    return g_sPaletteName;
}
//---------------------------------------------------------------------------
bool __fastcall ZXMSXMulticolorPalette::Convert(ZXImage* Image, Graphics::TBitmap* Bitmap)
{
