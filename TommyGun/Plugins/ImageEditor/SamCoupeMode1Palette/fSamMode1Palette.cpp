...
//---------------------------------------------------------------------------
TfrmSamMode1Palette *frmSamMode1Palette = NULL;
TSpeedButton* g_ButtonsInk[8];
TSpeedButton* g_ButtonsPaper[8];
TSpeedButton* g_ButtonsBright[2];
TSpeedButton* g_ButtonsFlash[2];
//---------------------------------------------------------------------------
__fastcall TfrmSamMode1Palette::TfrmSamMode1Palette(TComponent* Owner)
    : TForm(Owner)
{
}
//---------------------------------------------------------------------------
HRESULT __fastcall TfrmSamMode1Palette::Initialize(TZX_HPLUGIN PluginHandle, HINSTANCE hParentInstance)
{
    RL_HRESULT(S_OK);
...
//---------------------------------------------------------------------------
HRESULT __fastcall TfrmSamMode1Palette::Release(void)
{
    RL_HRESULT(S_OK);
...
//---------------------------------------------------------------------------
HRESULT __fastcall TfrmSamMode1Palette::GetPalette(ZXPalette*& Palette)
{
    RL_METHOD
    RL_HRESULT(S_OK);
    Palette = NULL;
...
//---------------------------------------------------------------------------
void __fastcall TfrmSamMode1Palette::spdInkBlackClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TfrmSamMode1Palette::spdPaperBlackClick(TObject *Sender)
{
    TComponent* Button = dynamic_cast<TComponent*>(Sender);
    if (true == SAFE_PTR(Button))
    {
...
//---------------------------------------------------------------------------
void __fastcall TfrmSamMode1Palette::spdBrightOffClick(TObject *Sender)
{
    TComponent* Button = dynamic_cast<TComponent*>(Sender);
    if (true == SAFE_PTR(Button))
    {
...
//---------------------------------------------------------------------------
void __fastcall TfrmSamMode1Palette::spdFlashOffClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TfrmSamMode1Palette::OnUpdatePaletteGUI(void)
{
