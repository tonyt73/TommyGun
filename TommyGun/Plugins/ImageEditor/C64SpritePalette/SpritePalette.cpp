...
//---------------------------------------------------------------------------
__fastcall SpritePalette::SpritePalette()
: ZXPalette(4, 160, 200, true),
  m_iColor(1)
{
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::Initialize(void)
{
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::SetColor(unsigned char iColor)
{
    if (iColor < 4)
    {
        m_iColor = iColor;
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::SetTableColor(unsigned char iColor, TColor Color)
{
    if (iColor < 4)
    {
...
//---------------------------------------------------------------------------
unsigned char __fastcall SpritePalette::GetColor(void)
{
    return m_iColor;
}
//---------------------------------------------------------------------------
TColor __fastcall SpritePalette::GetColor(unsigned char iColor)
{
    return ZXPalette::GetColor(iColor);
}
//---------------------------------------------------------------------------
void __fastcall SpritePalette::SetColorAt(ZXImage& Image, int X, int Y)
{
    Write(X, Y, true, Image);
}
//---------------------------------------------------------------------------
void __fastcall SpritePalette::GetColorAt(ZXImage& Image, int X, int Y)
{
    if (0 <= X && X < Image.Width && 0 <= Y && Y < Image.Height)
    {
        ...
        unsigned char cPixelShifts= 8 - (cPixelPos << 1);
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::Write(int X, int Y, bool bSet, ZXImage& Image)
{
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::Draw(ZXImage& Image, Graphics::TBitmap* Bitmap)
{
    //PERFORMANCE_PUSH
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::SetPixel(int iX, int iY, unsigned char iColor, bool bSet, ZXImage& Image)
{
    //PERFORMANCE_PUSH
...
//---------------------------------------------------------------------------
String __fastcall SpritePalette::GetColorAsString(ZXImage& Image, int X, int Y)
{
    String sColor("None");
    if (0 <= X && X < Image.Width && 0 <= Y && Y < Image.Height)
    {
...
//---------------------------------------------------------------------------
void __fastcall SpritePalette::Reset(void)
{
    ZXPalette::SetColor(0, clBlack);
    ZXPalette::SetColor(1, clWhite);
    ZXPalette::SetColor(2, clRed  );
    ZXPalette::SetColor(3, clBlue );
    SetColor(1);
}
//---------------------------------------------------------------------------
void __fastcall SpritePalette::Loaded(void)
{
    frmC64SpritePalette->RefreshPanels();
}
//---------------------------------------------------------------------------
