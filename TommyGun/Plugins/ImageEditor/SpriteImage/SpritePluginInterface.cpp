 ...
 * Mini-Plugins do not use registration functions.
...
FUNCTION_PREFIX SetPalettes(TStrings* pPalettes, std::vector<String>& vSignatures)
{
    ...
    {
        frmSpriteType->SetPalettes(pPalettes, vSignatures);
    }
    return S_OK;
}
//---------------------------------------------------------------------------
