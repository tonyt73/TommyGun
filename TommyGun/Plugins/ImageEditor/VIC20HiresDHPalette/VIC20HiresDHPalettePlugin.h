...
---------------------------------------------------------------------------*/
//---------------------------------------------------------------------------
#ifndef Vic20HiresDHPalettePluginH
#define Vic20HiresDHPalettePluginH
//-- APP --------------------------------------------------------------------
 ...
 */
//---------------------------------------------------------------------------
class Vic20HiresDHPalettePlugin : public ZXBasePlugin
{
private:
    ZXVic20HiresDHPalette         m_Palette;
    
public:
                    __fastcall  Vic20HiresDHPalettePlugin();
                    __fastcall ~Vic20HiresDHPalettePlugin();
