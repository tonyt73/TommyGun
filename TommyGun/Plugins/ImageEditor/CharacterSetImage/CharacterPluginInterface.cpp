...
#pragma hdrstop
//-- PLUGIN -----------------------------------------------------------------
ZXCharacterType* g_Plugin = NULL;
// Plugin Class Factory function
extern ZXCharacterType* NewPluginClass(void);
//-- PLUGIN FLAG INFORMATION ------------------------------------------------
DWORD  g_dwFlags = 0x0000;
const   String  g_sTypeSignature    = "Fonts";
//---------------------------------------------------------------------------
// Flags
/**
...
FUNCTION_PREFIX SetPalettes(TStrings* pPalettes, std::vector<String>& vSignatures)
{
    ...
    {
        frmCharacterType->SetPalettes(pPalettes, vSignatures);
    }
    return S_OK;
}
//---------------------------------------------------------------------------
