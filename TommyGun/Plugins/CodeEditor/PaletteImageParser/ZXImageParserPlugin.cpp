...
//---------------------------------------------------------------------------
void __fastcall ZXImageParserPlugin::GetFrameData(const String& sPixels, const String& sAttrs, const String& sMasks, const String& sPalette)
{
    if (sPixels.Trim() != "")
    {
...
//---------------------------------------------------------------------------
void __fastcall ZXImageParserPlugin::ConvertStringToData(unsigned char*& pData, const String& sData, bool bChangeEndianess)
{
    // delete the old data
