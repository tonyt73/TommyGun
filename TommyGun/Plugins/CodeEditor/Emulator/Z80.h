...
#define Z80_H
                               ...
                               /* Compilation options:       */
#define DEBUGGER               /* Compile debugging version  */
...
typedef struct
{
  ...
  unsigned long ITotal;               /* Total cycles                        */
  ...
  unsigned long InstrCount;           /* Instruction count                   */
} Z80;
...
/** StackOp() ************************************************/
/** Z80 emulation calls this function when a stack          **/
/** operation has being performed.                          **/
/************************************ TO BE WRITTEN BY USER **/
void StackOp(Z80* R, TStackOp StackOp, char* operand, word Value, word StackPtr, word func);


/** DebugString() ********************************************/
/** Z80 emulation calls this function when a rst 16         **/
/** operation has being performed.                          **/
/************************************ TO BE WRITTEN BY USER **/
void DebugString(Z80* R);
