...
//-- PLUGIN -----------------------------------------------------------------
TiledMapParserPlugin* g_Plugin = NULL;
// Plugin Class Factory function
extern TiledMapParserPlugin* NewPluginClass(void);
...
HRESULT WINAPI Signature(String& sSignature)
{
    RL_METHOD
    RL_HRESULT(S_OK)
    // we are an CodeEditor Mini-Plugin
...
{
    sDescription = "Index Tiled Maps (Index Tiled Map Table and Screens)";
    return S_OK;
}
//---------------------------------------------------------------------------
