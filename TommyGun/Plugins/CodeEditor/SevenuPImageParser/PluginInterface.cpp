...
//-- PLUGIN -----------------------------------------------------------------
SevenuPImageParserPlugin* g_Plugin = NULL;
// Plugin Class Factory function
extern SevenuPImageParserPlugin* NewPluginClass(void);
...
{
    sDescription = "SevenuP Image Parser (Sprites, Tiles, Fonts and Screen$)";
    return S_OK;
}
//---------------------------------------------------------------------------
