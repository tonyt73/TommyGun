...
{
    RL_METHOD
    frmImageParserOptions = new TfrmImageParserOptions(NULL);
}
//---------------------------------------------------------------------------
// Destructor
/**
...
__fastcall ZXImageParserPlugin::~ZXImageParserPlugin()
{
    ...
    SAFE_DELETE(frmImageParserOptions);
    Release();
}
//---------------------------------------------------------------------------
// InitialisePlugin
...
HRESULT __fastcall ZXImageParserPlugin::InitialisePlugin(ZXPlugin* pPlugin)
{
    ...
    if (true == SAFE_PTR(frmImageParserOptions))
    {
        hResult = frmImageParserOptions->Initialize(pPlugin);
    }
    return hResult;
}
//---------------------------------------------------------------------------
...
HRESULT __fastcall ZXImageParserPlugin::ReleasePlugin(void)
{
    ...
    if (true == SAFE_PTR(frmImageParserOptions))
    {
        hResult = frmImageParserOptions->Release();
    }
    SAFE_DELETE(frmImageParserOptions);
    return hResult;
}
...
HRESULT __fastcall ZXImageParserPlugin::GetOptionsPanel(TPanel*& Panel)
{
    ...
    if (true == SAFE_PTR(frmImageParserOptions))
    {
        Panel = frmImageParserOptions->panImageParser;
        hResult = S_OK;
    }
    return hResult;
}
...
//---------------------------------------------------------------------------
HRESULT __fastcall ZXImageParserPlugin::ParseResources(KXmlInfo*& XmlData, String& Resource, TStringList*& Code  )
{
    return E_FAIL;
}
//---------------------------------------------------------------------------
