...
#ifndef DEBUG_STRING
#define DEBUG_STRING( s ) OutputDebugString(AnsiString(s).c_str());
#endif//DEBUG_STRING
#else
#define DEBUG_STRING
#endif//_DEBUG
		...
		{\
			...
			{\
				...
				{\
					...
					DEBUG_STRING( sMsg + sFile + ", Func: " + sFunc + ", Line: " + sLine);\
				}\
			}\
			__except(true)\
			{\
