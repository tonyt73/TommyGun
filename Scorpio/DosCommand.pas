...
type
  ...
  TTerminatedEvent = procedure(Sender: TObject; ExitCode: Integer) of object;
  ...
  public
    ...
    property ExitCode: Integer read FExitCode; //exit code of the process
  published
...
procedure Register;
begin
  RegisterComponents('Scorpio', [TDosCommand]);
end;
